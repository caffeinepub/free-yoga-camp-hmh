...
export class Backend implements backendInterface {
    ...
    async getAdmission(arg0: bigint): Promise<Admission> {
        if (this.processError) {
            try {
    ...
    async getAllAdmissions(): Promise<Array<Admission>> {
        if (this.processError) {
            try {
    ...
    async getTotalAdmissions(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalAdmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
