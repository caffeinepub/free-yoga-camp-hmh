export default function WhatsAppButton() {
  const phone = "919057036745";
  const message = encodeURIComponent(
    "नमस्ते! निःशुल्क योग सेवा शिविर के बारे में जानकारी चाहिए।",
  );
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-full shadow-lg px-4 py-3 transition-all hover:scale-105 hover:shadow-xl group"
    ...
    >
      ...
      <div className="flex flex-col leading-tight">
        <span className="text-xs font-semibold">तुषार वर्मा</span>
        <span className="text-xs opacity-90">9057036745</span>
      </div>
    </a>
  );
}
